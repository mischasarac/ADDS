...
private:
    unordered_set<int> patron_ids;
    unordered_map<int, Document> borrowed_documents; // key: docid, value: patronid
    unordered_map<string, int> document_names; // key: name, value: docid
